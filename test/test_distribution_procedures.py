...
def traffic_assignment(ae_with_project, qtbot):    
    dialog = TrafficAssignmentDialog(ae_with_project)

    assignment_result = f"TrafficAssignment_DP"
...
def test_calibrate_gravity(ae_with_project, qtbot):
    ...
    dialog.out_name = "test/data/SiouxFalls_project/mod_negative_exponential.mod"
