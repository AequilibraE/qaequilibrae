...
class Ui_report(object):
    def setupUi(self, report):
        ...
        self.but_save_log = QtGui.QPushButton(report)
        self.but_save_log.setGeometry(QtCore.QRect(10, 610, 821, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.but_save_log.setFont(font)
        self.but_save_log.setObjectName(_fromUtf8("but_save_log"))
    ...
    def retranslateUi(self, report):
        ...
        self.but_save_log.setText(_translate("report", "Save log", None))
