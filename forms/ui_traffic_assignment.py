...
class Ui_traffic_assignment(object):
    def setupUi(self, traffic_assignment):
        ...
        self.skim_field.setGeometry(QtCore.QRect(60, 20, 531, 24))
        ...
        self.path_list.setGeometry(QtCore.QRect(10, 130, 611, 211))
        ...
        self.do_select_link.setGeometry(QtCore.QRect(10, 100, 141, 22))
        self.do_select_link.setObjectName(_fromUtf8("do_select_link"))
        self.do_path_file = QtGui.QCheckBox(self.tab_3)
        self.do_path_file.setGeometry(QtCore.QRect(10, 20, 171, 22))
        self.do_path_file.setObjectName(_fromUtf8("do_path_file"))
        self.select_path_file_name = QtGui.QPushButton(self.tab_3)
        self.select_path_file_name.setGeometry(QtCore.QRect(10, 50, 111, 27))
        self.select_path_file_name.setObjectName(_fromUtf8("select_path_file_name"))
        self.path_file_display = QtGui.QLabel(self.tab_3)
        self.path_file_display.setGeometry(QtCore.QRect(140, 55, 481, 17))
