...
# AequilibraE
#
# AequilibraE and other goodies for Transportation
#                             -------------------
#        begin                : 2014-03-19
...
PLUGINNAME = AequilibraE

PY_FILES = AequilibraE.py AequilibraEdialog.py __init__.py

EXTRAS = icon.png metadata.txt

UI_FILES = ui_AequilibraE.py
