...
from qaequilibrae.modules.menu_actions import run_route_choice, run_pt_skim, last_folder, run_module, load_isochrones
...
class AequilibraEMenu:
    def __init__(self, iface):
        ...
        self.add_menu_action(self.tr("Paths and assignment"), self.tr("Isochrones"), partial(load_isochrones, self))
        self.add_menu_action(
