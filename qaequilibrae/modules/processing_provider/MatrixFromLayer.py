...
class MatrixFromLayer(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo(tr('Importing the layer from QGIS :'))
        ...
        feedback.pushInfo(tr(f'Matrix imported as a {num_zones}x{num_zones} matrix'))
        feedback.pushInfo(' ')
        feedback.setCurrentStep(2)
        
        feedback.pushInfo(tr('A final sweep after the work...'))
