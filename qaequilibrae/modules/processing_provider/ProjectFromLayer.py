...
class ProjectFromLayer(TranslatableAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        feedback.pushInfo(tr('Generating empty aequilibrae project'))
        project = Project()
        ...
        feedback.pushInfo(tr('Getting parameters from link layer and setting up the AequilibraE project'))
